<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="_Map.aspx.cs" Inherits="WebApplication4.WebForm1" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=h87QAcacOGOKaLhyc6M6ZZ4C"></script>
...
<body onload="setHeight()" onresize="setHeight()" style="margin: 0px; padding: 0px; height: 100%; background-color: #0b7fab; font-family: STXihei; font-size: 15px">
            ...
            <table id="mapzone" style="border: hidden; border-color: red;">
                <tr>
                    <td style="background-color: blue; margin: 0px; border: 0px; padding: 0px;">
                        <div id="allmap" style="width: 100%; height: 100%; margin: 0px; background-color: white; padding: 0px;">
                            无法连接地图服务器,请检查互联网状态
                        </div>
                    </td>
                    <td id="infoZone" style="background-color: #0b7fab; vertical-align: top; width: 250px;">
                        <div id="infoDiv" style="background-color: #54b1d2; padding: 5px; height: 100%; overflow: auto;">
                            <div id="div1" style="font-family: STXihei; font-size: 17px; font-weight: bold; text-align: center">人防工事信息 </div>
                            当前用户数:
                                ...
                                <ul class="vconlist clearfix">
                                    ...
                                    <li>
                                     ...
                                     <li>
                                       ...
                                       <li>
                                        <a>
                                            <input id="btn_show_all_user" class="button orange small" onclick="showalluser();" type="button" value="显示人员分布态势" />
                                             <input id="btn_clear_all_user" class="button orange small" onclick="clearalluser();" type="button" value="取消" />
                                     </a>
                                           </li>
                                    <li>
                                         <a>
                                             <input id="btn_openHeatmap" class="button orange small" onclick="openUserHT();" type="button" value="显示热力图" />
                                             <input id="btn_clear_Heatmap" class="button orange small" onclick="closeHeatmap();" type="button" value="关闭" />
                                     </a>
                                    </li>
                                    <li>
                                        <a>
    ...
    <div class="div_map_tools" id="div_map_tools" style="visibility: visible">
        <a href="javascript:changeMode('NORMAL');" id="a_move">移动</a>
        <a href="javascript:changeMode('ALL');" id="a_total">全图</a>
        <a href="javascript:changeMode('CENTER');" id="a_center">居中</a>
        <a href="javascript:changeMode('DRAW_LINE');" id="a_distance">定位</a>
        <%--      
        <a href="javascript:changeMode('DRAW_SHAPE');" id="a_acreage">测面积</a>
        <a href="javascript:changeMode('DELETE_CONTROL');" id="a_clear">清除</a>--%>
    </div>
