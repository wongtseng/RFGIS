<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="_setSysTemUser.aspx.cs" Inherits="WebApplication4._setSysTemUser" %>
...
<body style="background-color:aliceblue;text-align:center;">
    ...
    <div>
                    ...
                    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/image/window_app_list_add.png" OnClick="btn_add_Click" ToolTip="添加用户信息"/>
    
        <asp:Panel ID="Panel_gridview" runat="server" HorizontalAlign="Center">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" HorizontalAlign="Center" OnRowDataBound="GridView1_RowDataBound" Width="1000px">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="UserName" HeaderText="系统用户名称" />
                    <asp:BoundField DataField="pw" HeaderText="用户密码" />
            ...
            <table align="center" class="auto-style11">
                <tr>
                    ...
                    <td>
                        ...
                        <asp:TextBox ID="tb_un" runat="server" Width="150px"></asp:TextBox>
                    </td>
                    <td>
                        <asp:Label ID="lb_pw" runat="server" Text="用户密码"></asp:Label>
                    </td>
                    <td>
                        ...
                        <asp:TextBox ID="tb_pw" runat="server" Width="150px"></asp:TextBox>
                    </td>
                    <td>用户类型</td>
                    <td>
